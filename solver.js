...
class Solver {
    ...
    startSolving1(){
        this.initEmptiesObject1()
        this.singlesFinder1()
        if(!this.isBoardSolved) this.backTracking1()
    }
    initEmptiesObject() {
	...
	async backTracking(){        
        ...
        if(this.boardValidation()){view.printBoard(this.board)
